...
export function YahooLogo({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 40" aria-hidden="true">
      <path
        d="M6 4c1.1-2.4 3.5-4 6.2-4h8.8c3.2 0 5.8 2.6 5.8 5.8 0 1.3-.4 2.5-1.2 3.5l-3.6 4.8c-.7.9-.7 2.2 0 3.1l3.4 4.5c.9 1.2 1.4 2.6 1.4 4.1 0 3.2-2.6 5.8-5.8 5.8h-8.6c-3.1 0-5.7-2.3-6.2-5.3-.3-1.7.1-3.4 1.1-4.8l3.3-4.3c.8-1 .8-2.5 0-3.5l-3.2-4.2C6.7 8.9 5.7 6.8 6 4z"
        fill="#6001D2"
      />
      <path d="M36.5 4c1.4-2.3 3.9-4 6.7-4h6c2.6 0 4.9 1.3 6.3 3.4l8.5 13.3c.8 1.2 2.4 1.4 3.5.5 1-.9 1.1-2.5.2-3.5l-3.6-4.5c-.9-1.2-.9-2.9.1-4.1 1.3-1.6 3.2-2.6 5.3-2.6 3.6 0 6.5 2.9 6.5 6.5v2c0 .8-.7 1.5-1.5 1.5h-3c-.8 0-1.5.7-1.5 1.5V34c0 1.7-1.3 3-3 3h-7c-1.7 0-3-1.3-3-3V23.6c0-.9-.7-1.6-1.6-1.6h-3.8c-.9 0-1.6.7-1.6 1.6V34c0 1.7-1.3 3-3 3h-7c-1.7 0-3-1.3-3-3V12.2c0-.8-.7-1.5-1.5-1.5h-3c-.8 0-1.5-.7-1.5-1.5v-5.2z"
        fill="#6001D2"
      />
      <circle cx="62" cy="36" r="4" fill="#FFDE00" />
    </svg>
  );
}
