...
import { Download, Loader2, Play, Wallet } from "lucide-react";
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {isAdmin && (
          <>
            ...
            <a className="inline-flex items-center gap-1.5 rounded-lg border border-[var(--color-border)] px-3 py-2 text-sm font-medium hover:bg-[var(--color-muted)]" href={`/api/hr/payroll/export?period=${period}`}>
