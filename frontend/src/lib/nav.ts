...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/app/reports", label: "Medical Report", icon: FileText, roles: [...CLINICAL, "super_admin"] },
  { href: "/app/financial-reports", label: "Financial Report", icon: TrendingUp, roles: ADMIN },
