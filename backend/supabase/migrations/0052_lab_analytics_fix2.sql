-- ============================================================================
-- 0052 — LAB ANALYTICS FIX v2: monthly series built via a grouped subquery
-- (0050/0051 had bugs: outer refs to the invoices alias inside the LATERAL,
-- then nested aggregates inside jsonb_agg. Final function: subquery form.)
-- ============================================================================
